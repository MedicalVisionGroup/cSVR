...
def srr_update(
    e: Stack, #stores slices, mask, transformation, resolution thicknesses
    v: Volume,
    ...
    v0 = volume[:, :, 1 : D - 1, 1 : H - 1, 1 : W - 1]  #volume.shape - torch.Size([1, 1, 126, 154, 174])
   # print("srr UPDATE")
