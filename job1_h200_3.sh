...
python /data/vision/polina/users/mfirenze/cSVR/train_from_bulk_wdb_yaml.py --config ./experiments/jan22_train_params_check_new_config_fix_lr_rep_clean_a6000_real_multi_scale_debug_weights_last4.yaml # export JOB_NAME="jan14__mlp_norm_64size_vec_rots_rep_large_unet"
# export JOB_NAME="jan22_train_params_check_new_config_fix_lr_rep_clean_a6000_real_multi_scale_debug_weights_last4"

# envsubst < job1_h200_3.sh | sbatch 
