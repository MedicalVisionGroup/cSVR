...
def add_argparse_args(parser):
  ...
  #  parser.add_argument('--augment', dest='augment', action='store_true', help='augment training data')
    ...
    parser.add_argument('--config',  dest='config',  default='', help='config file name')
    parser.add_argument('--remarks_add',  dest='remarks_add',  default='', help='additional info for model name')
