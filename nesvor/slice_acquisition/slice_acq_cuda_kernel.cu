...
__global__ void slice_acquisition_adjoint_forward_cuda_kernel( 
    ...
    // if (threadIdx.x == 25000 && blockIdx.x == 15) {
    //     if (interp_psf) {
    //         printf("Kernel interp_psf is TRUE (Nearest Neighbor/Interpolated PSF path)\n");
    //     } else {
    //         printf("Kernel: interp_psf is FALSE (Linear/Trilinear Interpolation path)\n");
    //     }
    // }
    // if (idx == 15) {
    //     if (interp_psf) {
    ...
    //     printf("DEBUG: Volume indexing dimensions calculated.\n");
    //     printf("DEBUG: Sy (Width) = %d\n", Sy);
    //     printf("DEBUG: Sz (Height * Width) = %d\n", Sz);
    // }
    for (int iz_p = -d_p/2, i_p = 0; iz_p < (d_p+1)/2; iz_p++) {
        for (int iy_p = -h_p/2; iy_p < (h_p+1)/2; iy_p++) {
            for (int ix_p = -w_p/2; ix_p < (w_p+1)/2; ix_p++, i_p++) {
            ...
            for (int ix_p = -w_p/2; ix_p < (w_p+1)/2; ix_p++, i_p++) {
                ...
                if (interp_psf) { // NN
                    ...
                    if (vol_mask == NULL || vol_mask[i_v]) {
                        ...
                        //     if (psf_val > 0.01) { 
                        //         printf("NN Path 1: Index: %d, PSF Value: %f, Slice Value (s): %f\n", i_v, psf_val, s);
                          
                        //         // Corrected the likely typo psf_val_ to psf_val
                        //     }
                        // }
                    ...
                    if (vol_mask == NULL || vol_mask[i_v + 1]) {
                        ...
                        //     // NEW CONDITION ADDED HERE
                        //     if (psf_val > 0.01) { 
                        //         printf("NN Path 2: Index: %d, PSF Value: %f, Slice Value (s): %f\n", i_v + 1, psf_val, s);
                        //         // Corrected the likely typo psf_val_ to psf_val      
                        //     }
                        // }
                    ...
                    if (vol_mask == NULL || vol_mask[i_v + Sy]) {
                        ...
                        //     // NEW CONDITION ADDED HERE
                        //     if (psf_val > 0.01) { 
                        //         printf("NN Path 3: Index: %d, PSF Value: %f, Slice Value (s): %f\n", i_v + Sy, psf_val, s);
                        //         // Corrected the likely typo psf_val_ to psf_val      
                        //     }
                        // }
                    ...
                    if (vol_mask == NULL || vol_mask[i_v + Sz]) {
                        ...
                        //     // NEW CONDITION ADDED HERE
                        //     if (psf_val > 0.01) { 
                        //         printf("NN Path 4: Index: %d, PSF Value: %f, Slice Value (s): %f\n", i_v + Sz, psf_val, s);
                        //         // Corrected the likely typo psf_val_ to psf_val      
                        //     }
                        // }
                    ...
                    if (vol_mask == NULL || vol_mask[i_v + 1 + Sy]) {
                        ...
                        //     // NEW CONDITION ADDED HERE
                        //     if (psf_val > 0.01) { 
                        //         printf("NN Path 5: Index: %d, PSF Value: %f, Slice Value (s): %f\n", i_v+1+Sy, psf_val, s);
                        //         // Corrected the likely typo psf_val_ to psf_val      
                        //     }
                        // }
                    ...
                    if (vol_mask == NULL || vol_mask[i_v + 1 + Sz]) {
                        ...
                        //     // NEW CONDITION ADDED HERE
                        //     if (psf_val > 0.01) { 
                        //         printf("NN Path 6: Index: %d, PSF Value: %f, Slice Value (s): %f\n", i_v + 1 + Sz, psf_val, s);
                        //         // Corrected the likely typo psf_val_ to psf_val      
                        //     }
                        // }
                    ...
                    if (vol_mask == NULL || vol_mask[i_v + Sy + Sz]) {
                        ...
                        //     // NEW CONDITION ADDED HERE
                        //     if (psf_val > 0.01) { 
                        //         printf("NN Path 7: Index: %d, PSF Value: %f, Slice Value (s): %f\n", i_v + Sy + Sz, psf_val, s);
                        //         // Corrected the likely typo psf_val_ to psf_val      
                        //     }
                        // }
                    ...
                    if (vol_mask == NULL || vol_mask[i_v + Sy + Sz + 1]) {
                        ...
                        if (i_v == i_v + Sy + Sz + 1) {
                            // NEW CONDITION ADDED HERE
                            // if (psf_val > 0.01) { 
                            //     printf("NN Path 8: Index: %d, PSF Value: %f, Slice Value (s): %f\n", i_v + Sy + Sz + 1, psf_val, s);
                            //     // Corrected the likely typo psf_val_ to psf_val      
                            // }
                        }
